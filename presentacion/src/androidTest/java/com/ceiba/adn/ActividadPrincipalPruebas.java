...
import com.ceiba.adn.pagina.ActividadPrincipalPagina;
import com.ceiba.adn.pagina.DialogoVehiculoPagina;
...
public class ActividadPrincipalPruebas {
    ...
    @Rule
    public ActivityTestRule<ActividadPrincipal> actividadPrincipalRegla = new ActivityTestRule<>(ActividadPrincipal.class);
